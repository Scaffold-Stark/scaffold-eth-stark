...
import { deepMergeContracts } from "@scaffold-stark-2/utils/scaffold-stark/contract";
      ...
      <div className="p-6 px-8 mx-2 border-gradient rounded-[5px] w-full max-w-6xl contract-content">
        ...
        <div className="flex flex-col gap-12 sm:gap-24 sm:flex-row">
          <div className="flex-1">
            ...
            <p className="my-2">
              This tool allows you to fetch the ABI of a contract by entering its address. It will download a
              configuration file that can be used to replace or append to your local{" "}
              <code className="text-function">predeployedContracts.ts</code> file, allowing you to debug in the{" "}
            ...
            <ol className="flex flex-col gap-2 list-decimal list-outside my-6 space-y-1 ml-4">
              <li className="pl-3">Enter the contract address and name within the designated input fields.</li>
              <li className="pl-3">
                Click the <strong className="text-function">Download Contract File</strong> button.
              </li>
              <li className="pl-3">
                The tool will fetch the ABI, address, and classHash from the network and generate a configuration file.
              </li>
              <li className="pl-3">
                Download the file and replace it to your local{" "}
                <code className="text-function">configExternalContracts.ts</code> file.
              </li>
              <li className="pl-3">
                Use the{" "}
                ...
                page to interact with and test the contract using the scaffold hooks.
              </li>
            </ol>
            <p className="mt-2">

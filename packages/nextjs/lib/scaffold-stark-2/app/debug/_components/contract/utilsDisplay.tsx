...
import { AbiOutput, parseParamWithType } from "@scaffold-stark-2/utils/scaffold-stark/contract";
import {
  isCairoByteArray,
...
export const displayTxResult = (
  ...
  if (functionOutputs != null && functionOutputs.length != 0) {
    ...
    if (Array.isArray(parsedParam)) {
      ...
      const displayable = JSON.stringify(parsedParam.map(mostReadable), replacer);
    ...
    return isCairoContractAddress(type) && validateChecksumAddress(parsedParam) && !asText ? (

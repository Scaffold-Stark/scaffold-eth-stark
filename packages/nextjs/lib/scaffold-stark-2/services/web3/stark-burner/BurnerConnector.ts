...
import { BurnerAccount, burnerAccounts } from "@scaffold-stark-2/utils/devnetAccounts";
...
import { Account, AccountInterface, Call, CallData, RpcProvider, byteArray, uint256 } from "starknet";

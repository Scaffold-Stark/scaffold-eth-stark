...
export const BlockExplorer = () => {
  ...
  return (
    <div>
      <label htmlFor="blockexplorer-modal" className="btn btn-sm font-normal gap-1 border border-[#32BAC4] shadow-none">
      ...
      <label htmlFor="blockexplorer-modal" className="modal cursor-pointer">
        <label className="modal-box relative">
          ...
          <label htmlFor="blockexplorer-modal" className="btn btn-ghost btn-sm btn-circle absolute right-3 top-3">
            ✕
          </label>

...
import { addIndexedArgsToEvent, useDeployedContractInfo } from "@scaffold-eth-2/hooks/scaffold-eth";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "@scaffold-eth-2/utils/scaffold-eth/contract";

...
import { addIndexedArgsToEvent, useDeployedContractInfo } from "~~/core/eth/hooks";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "~~/core/eth/utils/scaffold-eth/contract";
